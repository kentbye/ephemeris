$ns.natalchart = function ($transitPlanets, $natalPlanets) {
	...
	signImageArray[0] = new Image();	// Aries glyph image
	// Aries glyph image
	...
	signImageArray[1] = new Image();	// Taurus glpyh image
	// Taurus glpyh image
	...
	signImageArray[2] = new Image();	// Gemini glyph image
	// Gemini glyph image
	...
	signImageArray[3] = new Image(); // Cancer glyph images
	// Cancer glyph image
	...
	signImageArray[4] = new Image();	// Leo glyph image
	// Leo glyph image
	...
	signImageArray[5] = new Image();	// Virgo glyph image
	// Virgo glyph image
	...
	signImageArray[6] = new Image();	// Libra glyph image
	// Libra glyph image
	...
	signImageArray[7] = new Image();	// Scorpio glyph image
	// Scorpio glyph image
	...
	signImageArray[8] = new Image();	// Sagittarius glyph image
	...
	signImageArray[8].src =	'data:image/png;base64,';
		...
		signImageArray[9] = new Image();	// Capricorn glyph image
	...
	signImageArray[10] = new Image();	// Aquarius glyph image
	...
	signImageArray[11] = new Image();	// Pisces glyph image
	// Pisces glyph image
	signImageArray[11].src =	'data:image/png;base64,';
		...
		planetImageArray['sun'] = new Image();	// Sun glyph image
	// Sun glyph image
	...
	planetImageArray['moon'] = new Image();	// moon glyph image
	// moon glyph image
	planetImageArray['moon'].src = 'data:image/png;base64,';
		...
		planetImageArray['mercury'] = new Image();	// mercury glyph image
	// mercury glyph image
	planetImageArray['mercury'].src =	'data:image/png;base64,';
		...
		planetImageArray['venus'] = new Image();	// venus glyph image
	// venus glyph image
	planetImageArray['venus'].src =	'data:image/png;base64,';
		...
		planetImageArray['mars'] = new Image();	// mars glyph image
	// mars glyph image
	planetImageArray['mars'].src =	'data:image/png;base64,';
		...
		planetImageArray['jupiter'] = new Image();	// jupiter glyph image
	// jupiter glyph image
	planetImageArray['jupiter'].src =	'data:image/png;base64,';
		...
		planetImageArray['saturn'] = new Image();	// saturn glyph image
	// saturn glyph image
	planetImageArray['saturn'].src =	'data:image/png;base64,';
		...
		planetImageArray['uranus'] = new Image();	// uranus glyph image
	// uranus glyph image
	planetImageArray['uranus'].src =	'data:image/png;base64,';
		...
		planetImageArray['neptune'] = new Image();	// neptune glyph image
	// neptune glyph image
	planetImageArray['neptune'].src =	'data:image/png;base64,';
		...
		planetImageArray['pluto'] = new Image();	// pluto glyph image
	// pluto glyph image
	planetImageArray['pluto'].src =	'data:image/png;base64,';
		...
		planetImageArray['chiron'] = new Image();	// chiron glyph image
	// chiron glyph image
	...
	aspectImageArray['oppose'] = new Image();	// opposition glyph image
	...
	aspectImageArray['conjunct'] = new Image();	// conjunction glyph image
	...
	aspectImageArray['square'] = new Image();	// square glyph image
	// square glyph image
	...
	aspectImageArray['trine'] = new Image();	// trine glyph image
	// trine glyph image
	...
	aspectImageArray['sextile'] = new Image();	// sextile glyph image
	// sextile glyph image
	...
	aspectImageArray['quincunx'] = new Image();	// quincunx glyph image
